    ...
    Tables: {
      ...
      league_manager_ledger_cache: {
        Row: {
          ...
          trade_any_picks: boolean;
          trade_count: number;
          trade_net: number;
          trade_points_in: number;
          trade_points_out: number;
          trade_rank: number | null;
          ungradable_slots: Json;
          waiver_faab_spent: number | null;
          waiver_hits: number;
          waiver_moves: number;
          waiver_points_on_roster: number;
          waiver_points_per_dollar: number | null;
          waiver_points_started: number;
          waiver_rank: number | null;
          weeks: Json;
          weeks_graded: number;
          weeks_with_ungraded_slots: number;
        ...
        Relationships: [
          {
            foreignKeyName: "league_manager_ledger_cache_league_id_fkey";
            columns: ["league_id"];
            isOneToOne: false;
            referencedRelation: "leagues";
            referencedColumns: ["id"];
      ...
      player_idp_seasons: {
        Row: {
          ...
          bonus_sack_2p: number | null;
          bonus_tkl_10p: number | null;
          computed_at: string;
          def_snp: number | null;
          ...
          idp_fum_ret_yd: number | null;
          idp_int: number | null;
          idp_int_ret_yd: number | null;
          idp_pass_def: number | null;
          idp_pass_def_3p: number | null;
          idp_qb_hit: number | null;
          idp_sack: number | null;
          idp_sack_yd: number | null;
        ...
        Relationships: [
          {
            foreignKeyName: "player_idp_seasons_player_id_fkey";
            columns: ["player_id"];
            isOneToOne: false;
            referencedRelation: "players";
            referencedColumns: ["id"];
