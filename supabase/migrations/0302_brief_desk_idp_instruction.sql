-- IDP-213 (plan R-21): the Brief desk instructions gain rule 13, how to write
-- about a defensive player (coverage not_covered, Sleeper default IDP scoring).
--
-- Data only. Access matrix unchanged: beacon_settings keeps its existing policies.
-- The update is guarded on the md5 of the previous seed text, so a copy the
-- owner has edited at /admin/brief-desk/settings is never overwritten; in that
-- case this is a no-op and rule 13 has to be added by hand there.
-- Text generated from lib/brief-desk/instructions-seed.ts; do not edit by hand.
...
where key = 'bd_brief_instructions'
  and md5(value #>> '{}') = 'af2bdd4260f3b7b80c65dc1eb84ba75b';
