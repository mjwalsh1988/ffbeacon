    ...
    <section aria-labelledby="guides-cta-heading">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        ...
        >
          ...
          <h2
            id="guides-cta-heading"
            className="mt-3 max-w-2xl text-3xl font-semibold tracking-tight sm:text-4xl"
          >
            The tools are already live.
          </h2>
          <p className="mt-3 max-w-xl text-base leading-relaxed text-ink-muted">
            Guides will land here as they&rsquo;re written. In the meantime,
            the rankings, league sync, and FAAB calculator are ready to use
            today.
          </p>
