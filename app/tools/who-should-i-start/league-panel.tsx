...
const TOOL_PATH = "/tools/who-should-i-start";
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-xs leading-relaxed text-ink-muted">
            Connect a Sleeper league and we will score every player under
            your league&apos;s own rules, then work out how many points each
            one really adds to your starting lineup.
          </p>
        </div>
        {!open && (
          <button
