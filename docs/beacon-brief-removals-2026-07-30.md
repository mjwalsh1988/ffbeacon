...
Discord posts for these articles were deliberately left in place.

Three further slugs from the original review were already `archived` by migration
0151 and needed no action: `jacoby-brissett-new-deal-cardinals-2026-starter`,
`geno-smith-case-inactive-no-charges`,
`kyle-shanahan-car-accident-chris-foerster-49ers-training-camp`.

A fourth, `kyle-shanahan-car-accident-limited-49ers-training-camp-2026`, was
pulled from the list on review: it is the merged survivor from 0151 and the
destination of a permanent redirect, so deleting it would have pointed that
redirect at a 404.

# Group A: deaths and illness of people with no active NFL role
...
# Group B: ceremonial honors and tributes
...
# Group C: uniforms, stadiums, branding
...
# Group D: league business, ownership, finance, calendar
...
# Group E: broadcast and media careers
...
# Group F: non-player staff with no scheme or usage change
# Both Ryan Gold rows go together. The archived one 308-redirected to the
# published one, so the redirect pair was removed from next.config.ts.
...
# Group G: off-field personal items with no availability impact
caleb-williams-iceman-trademark-refused
saquon-barkley-family-safe-home-burglary

# Group H: wrong sport (basketball recruit)
marcus-spears-jr-commits-texas-reclassifies-2026

# Group I: duplicate coverage, keeping aaron-donald-rams-return-contract
aaron-donald-return-decision-mcvay-very-strict-process
aaron-donald-return-decision-not-close-rams-training-camp
